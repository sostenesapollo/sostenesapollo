...
const GithubIcon = ({className=""}) => <button type="button" data-mdb-ripple="true" data-mdb-ripple-color="light" className={`inline-block p-3 mb-2 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out ${className}`} style={{backgroundColor:'#333'}}>
...
const TwitterIcon= ({className=""}) => <button type="button" data-mdb-ripple="true" data-mdb-ripple-color="light" className={`inline-block p-3 mb-2 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out ${className}`} style={{backgroundColor:'#1da1f2'}}>
...
const GmailIcon= ({className=""}) => <button type="button" data-mdb-ripple="true" data-mdb-ripple-color="light" className={`inline-block p-3 mb-2 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out ${className}`} style={{backgroundColor:'#ea4335'}}>
...
const YoutubeIcon= ({className=""}) => <button type="button" data-mdb-ripple="true" data-mdb-ripple-color="light" className={`inline-block p-3 mb-2 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out ${className}`} style={{backgroundColor:'#ff0000'}}>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="w-7 h-7"><path fill="currentColor" d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"/></svg>
</button>

const WhatsappIcon= ({className=""}) => <button type="button" data-mdb-ripple="true" data-mdb-ripple-color="light" className={`inline-block p-3 mb-2 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out ${className}`} style={{backgroundColor:'#128c7e'}}>
...
">
    ...
    <div className="flex">
      <h2 id="industry-title" class="print:text-6xl lg:text-xl md:text-md mr-auto text-md font-semibold text-gray-750 pb-px">
        {/* Software Engineer */}
        <a href="https://github.com/sostenesapollo" target="_blank" rel="noreferrer">
          <GithubIcon className="mr-2"/>
        </a>
        <a href="https://twitter.com/SostenesApollo" target="_blank" rel="noreferrer">
          <TwitterIcon className="mr-2"/>
        </a>
        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=sostenesapollo25@gmail.com" target="_blank" rel="noreferrer">
          <GmailIcon className="mr-2"/>
        </a>
        <a href="https://www.linkedin.com/in/sostenesapollo/" target="_blank" rel="noreferrer">
          <LinkedInIcon className="mr-2"/>
        </a>
        <a href="https://www.youtube.com/channel/UCL86DlZsoIU3-kjqiF662vg" target="_blank" rel="noreferrer">
          <YoutubeIcon className="mr-2"/>
        </a>
        <a href="https://wa.me/+5599988284904" target="_blank" rel="noreferrer">
